 ...
 */
export function calculateMilestoneDuration(initiativeId, targetMilestone) {
  const data = store.read();
 ...
 */
export function getMilestoneDurationBreakdown(initiativeId) {
  const data = store.read();
 ...
 */
export function initializeDailySnapshots() {
  const data = store.read();
 ...
 */
export function getAllMilestoneDurations(type = null) {
  const data = store.read();
  ...
  return initiatives.map(initiative => ({
    ...
    milestoneDetails: getMilestoneDurationBreakdown(initiative.id)
  }));
}
